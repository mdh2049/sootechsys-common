...
insert into auth (auth_name) values ('ROLE_USER');
insert into auth (auth_name) values ('ROLE_ADMIN');

insert into user_auth (user_id, auth_name) values (1, 'ROLE_USER');
insert into user_auth (user_id, auth_name) values (1, 'ROLE_ADMIN');
insert into user_auth (user_id, auth_name) values (2, 'ROLE_USER');